...
OUTPUT_VIDEO_PATH = "../test_results/edgetam/scooping_tracking_demo.mp4"
SAVE_TRACKING_RESULTS_DIR = "../tracking_results/edgetam"
...
def main():
    model_cfg_path = Path("sam2/configs")
    model_cfg_file = "edgetam.yaml"
